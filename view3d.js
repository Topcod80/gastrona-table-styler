...
function load3D(){
 ...
 loading3D=new Promise((resolve,reject)=>{if(window.Table3D){resolve();return;}const script=document.createElement('script');script.src='./dist/table3d.js?v=0.40.4';script.onload=resolve;script.onerror=()=>reject(Error('load'));document.head.append(script);});
 update3DControls();
 loading3D.then(()=>{
